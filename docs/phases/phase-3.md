...
| 10 | Deploy ขึ้น live site | ⏸ ยังไม่ push/deploy - รอผู้ใช้ยืนยันก่อน (ทั้งสองคำสั่ง outward-facing) |
...
รอยืนยันจากผู้ใช้ก่อน (คำสั่ง outward-facing) หลังจากนั้น Phase 4 (คำอธิบายภาพ
- ลูกศร/กล่อง/ข้อความ/badge/เซ็นเซอร์/caption/crop) เป็นขั้นต่อไปตามลำดับใน
CLAUDE.md เว้นแต่ผู้ใช้อยากปิดช่องว่างการทดสอบมือ (ข้อ 1-2 ด้านบน) ก่อน
